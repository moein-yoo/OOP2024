...
public class RegistryMenuView extends Menu{
    ...
    public static String[] captchaAsciiArtCheckerGraphic() {
        String[] ascii_art = new String[10];
        ascii_art[0] = "                        ,     ,\n" +
                "                        |\\---/|\n" +
                "                       /  , , |\n" +
        ...
        answer[0] = ascii_art[index];
        if (index==0) answer[1] = "wolf";
        if (index==1) answer[1] = "camel";
        if (index==2) answer[1] = "dolphin";
        if (index==3) answer[1] = "elephant";
        if (index==4) answer[1] = "fish";
        if (index==5) answer[1] = "horse";
        if (index==6) answer[1] = "monkey";
        if (index==7) answer[1] = "bee";
        if (index==8) answer[1] = "rabbit";
        if (index==9) answer[1] = "spider";
        return answer;
    }
}
